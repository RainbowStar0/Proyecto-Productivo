# Generated by Django 5.1.1 on 2024-12-05 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_doc', models.CharField(choices=[('TI', 'Targeta de identidad'), ('CC', 'Cedula de ciudadania'), ('CE', 'Cedula de extranjeria'), ('PPT', 'Permiso de proteccion especial')], default='CC', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=100)),
                ('direccion', models.CharField(max_length=255)),
                ('centro_de_formacion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='adso_app.centro_formacion')),
            ],
        ),
        migrations.CreateModel(
            name='Ambiente',
            fields=[
                ...
                ('tipo_ambiente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='adso_app.tipo_ambiente')),
            ],
        ),
        migrations.CreateModel(
            name='mobiliario',
            fields=[
                ...
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='adso_app.tipo_mobiliario')),
            ],
        ),
    ]
