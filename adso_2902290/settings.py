"""
Django settings for adso_2902290 project.
...
SECRET_KEY = 'django-insecure-5!=1lod40-)j)@=5q@28$%4ax2xyljpi!f(#%03g)4_j2b6qc^'
...
WSGI_APPLICATION = 'adso_2902290.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = ['adso_app/Public']
